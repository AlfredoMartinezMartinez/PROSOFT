...
public class Usuario {
	...
	public static int insert(String nombre, String apellidos, String login, String pass, String correo, String rol)
		...
		/*
		 * Debe implementarse la lï¿½gica para insertar el contenido de un objeto
		 ...
		 * la inserciï¿½n es la siguiente
		 * "INSERT INTO personal VALUES('"+this.mLogin+"','"+this.mPassword+"');"
		 * AYUDA2: Del mismo modo que para consultar la informaciï¿½n, el agente provee
		 * de un mï¿½todo "select", para hacer una inserciï¿½n el agente provee de un
		 * mï¿½todo "insert"
		 */
	}
