...
public class GestorUsuario {
	...
	/**
	 * Método que se encarga de la creacion de un usuario
	 * 
	 * @param nombre
	...
	/**
	 * Método que se encarga de logear al usuario, comprobando para ello si el
	...
	/**
	 * Método que comprueba que tipo de usario es, es decir administrador, o
	 * usuario normal.
	 * 
	 * @param nombre_usuario
	 *            Atributo para el nombre de usuario tipo cadena
	...
	/**
	 * Método que comprueba si el usuario ha sido eliminado correctamente. No
	 * implementado
	 * 
	 * @param usuario
	 *            Usuario a eliminar
	...
	/**
	 * Método que permite la generacion de mensajes. No implementado
	 * 
	 * @param msg
	 *            Mensaje a generar
