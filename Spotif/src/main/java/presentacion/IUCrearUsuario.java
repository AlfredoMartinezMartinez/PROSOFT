 ...
 * @author Alfredo
 */
public class IUCrearUsuario extends javax.swing.JFrame {
	...
	private void jButtonCrearUsuarioActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButtonCrearUsuarioActionPerformed
		...
		try {
			...
			boolean autenticar1 = GestorUsuario.crearUsuario(jTextFieldNombre.getText(), jTextFieldApellidos.getText(),
					login, password, correo, "usuario");

			if (autenticar1) {

				registrado.setText("Usuario registrado");
				IULogin framelog = new IULogin();
	...
	public static void main(String args[]) {
		...
		try {
			...
			java.util.logging.Logger.getLogger(IUCrearUsuario.class.getName()).log(java.util.logging.Level.SEVERE,
					null, ex);
		...
		java.awt.EventQueue.invokeLater(new Runnable() {
			public void run() {
				new IUCrearUsuario().setVisible(true);
			}
		});
	}
