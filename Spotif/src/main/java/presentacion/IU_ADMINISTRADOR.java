 ...
 * @author Alfredo
 */
public class IU_ADMINISTRADOR extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(IU_ADMINISTRADOR.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
