...
public class TestAgenteUsuario {
	 ...
	 * SQL. Error recogido en el c�digo de la clase AgenteUsuario con try-catch
	 * 
	 * @throws Exception
	 *             control de errores
	 */
	...
	/**
	 * Test que devuelve verdadero si el usuario ya est� en la BBDD. Error recogido
	 ...
	 * Usuario esperado. Gracias por ense�arnos la creacion del metodo equals en 2
	 * segundos.Muy util
	 * 
	 * @throws Exception
	 *             Control de errores
