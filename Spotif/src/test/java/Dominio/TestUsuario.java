...
public class TestUsuario {
	...
	/**
	 * test que da como verdadero si no existe el password;usuario devuelto igual a null
	 * True False = False
	 * 
	 * @throws Exception
	 *             control de excepciones
	...
	/**
	 * test que da como verdadero si no existe el login;usuario devuelto igual a null
	 * True False = False
	 * 
	 * @throws Exception
	 *             control de excepciones
	...
	/**
	 * test que da como verdadero si no existe el login ni el password;usuario devuelto igual a null
	 * False False = False
	 * 
	 * @throws Exception
	 *             control de excepciones
